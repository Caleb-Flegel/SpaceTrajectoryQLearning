...
template <class T> elements<T> calc_k(const T & h, const elements<T>  & y, coefficients<T> & coeff, const T & accel, const T & curTime, const T & timeFinal, const elements<T> & mars, const T & marsCraftDist) {
...
template <class T> elements<T> calc_kPlanet(const T & h, const elements<T>  & y, const T & curTime, const T & timeFinal) {
	return elements<T>( h*calcRate_r(y), 
						h*calcRate_theta(y), 
						h*calcRate_z(y), 
...
template <class T> T calcRate_vr(const elements<T> & y, coefficients<T> & coeff, const T & accel, const T & curTime, const T & timeFinal, const elements<T> & mars, const T & marsCraftDist) {
...
template <class T> T calcRate_vtheta(const elements<T> & y, coefficients<T> & coeff, const T & accel, const T & curTime, const T & timeFinal, const elements<T> & mars, const T & marsCraftDist) {
...
template <class T> T calcRate_vz(const elements<T> & y, coefficients<T> & coeff, const T & accel, const T & curTime, const T & timeFinal, const elements<T> & mars, const T & marsCraftDist) {
...
template <class T> T calcRate_vrPlanet(const elements<T> & y) {
	return ((-constG * massSun * y.r) / (pow(pow(y.r, 2) + pow(y.z, 2), 1.5))) + 
			(pow(y.vtheta,2) / y.r);
}

template <class T> T calcRate_vthetaPlanet(const elements<T> & y) {
	return (0.0) + 
			(-y.vr*y.vtheta / y.r);
}

template <class T> T calcRate_vzPlanet(const elements<T> & y) {
	return ((-constG * massSun * y.z) / pow(pow(y.r, 2) + pow(y.z, 2), 1.5)) + 
			(0.0);
}